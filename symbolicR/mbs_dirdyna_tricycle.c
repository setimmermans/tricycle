...
// Forward Kinematics 
  ...
  BeF813 = OpF111+OM213*OM313;
  AlF213 = C13*(AlF211+BS511*s->dpt[2][13]+BeF611*s->dpt[3][13])+S13*(AlF311+BS911*s->dpt[3][13]+BeF811*s->dpt[2][13]);
  AlF313 = C13*(AlF311+BS911*s->dpt[3][13]+BeF811*s->dpt[2][13])-S13*(AlF211+BS511*s->dpt[2][13]+BeF611*s->dpt[3][13]);
  OpM213_1 = OpM311_1*S13+C13*S6;
  OpM313_1 = OpM311_1*C13-S13*S6;
  AlM213_1 = C13*(AlM211_1-OpM111_1*s->dpt[3][13])+S13*(AlM311_1+OpM111_1*s->dpt[2][13]);
  AlM313_1 = C13*(AlM311_1+OpM111_1*s->dpt[2][13])-S13*(AlM211_1-OpM111_1*s->dpt[3][13]);
  ...
  AlM213_5 = C13*(AlM211_5-OpM111_5*s->dpt[3][13])+S13*(AlM311_5+OpM111_5*s->dpt[2][13]);
  AlM313_5 = C13*(AlM311_5+OpM111_5*s->dpt[2][13])-S13*(AlM211_5-OpM111_5*s->dpt[3][13]);
  AlM213_6 = s->dpt[2][13]*C11p7*S13+C13*(AlM211_6-s->dpt[3][13]*C11p7);
  AlM313_6 = s->dpt[2][13]*C11p7*C13-S13*(AlM211_6-s->dpt[3][13]*C11p7);
  ...
  AlF114 = AlF111+BeF211*s->dpt[2][13]+BeF311*s->dpt[3][13]-s->dpt[2][18]*(OpF313-OM113*OM213);
  ...
  AlM114_1 = AlM111_1-OpM311_1*s->dpt[2][13]-OpM313_1*s->dpt[2][18]+s->dpt[3][13]*S6;
  AlM214_1 = AlM213_1*C14+S14*(AlM313_1+OpM111_1*s->dpt[2][18]);
  AlM314_1 = -(AlM213_1*S14-C14*(AlM313_1+OpM111_1*s->dpt[2][18]));
  ...
  AlM114_5 = AlM111_5-OpM311_5*s->dpt[2][13]-OpM313_5*s->dpt[2][18]+s->dpt[3][13]*S6;
  AlM214_5 = AlM213_5*C14+S14*(AlM313_5+OpM111_5*s->dpt[2][18]);
  AlM314_5 = -(AlM213_5*S14-C14*(AlM313_5+OpM111_5*s->dpt[2][18]));
  OpM214_6 = S11p7*S13p14;
  OpM314_6 = S11p7*C13p14;
  AlM114_6 = -S11p7*(s->dpt[2][13]+s->dpt[2][18]*C13);
  AlM214_6 = AlM213_6*C14+S14*(AlM313_6+s->dpt[2][18]*C11p7);
  AlM314_6 = -(AlM213_6*S14-C14*(AlM313_6+s->dpt[2][18]*C11p7));
  AlM114_7 = AlM111_7+s->dpt[3][13]+s->dpt[2][18]*S13;
  AlM214_7 = AlM213_7*C14+AlM313_7*S14;
  AlM314_7 = -(AlM213_7*S14-AlM313_7*C14);
  AlM114_11 = s->dpt[3][13]+s->dpt[2][18]*S13;
  AlM214_13 = s->dpt[2][18]*S14;
  AlM314_13 = s->dpt[2][18]*C14;
  ...
  AlF117 = AlF115*C16+AlF214*S16-s->dpt[1][22]*(OM216*OM216+OM316*OM316)+s->dpt[2][22]*(BS216-OpF315)+s->dpt[3][22]*(
 BS316+OpF216);
  AlF317 = C17*(AlF315+BS916*s->dpt[3][22]+BeF716*s->dpt[1][22]+BeF816*s->dpt[2][22])-S17*(AlF216+BS516*s->dpt[2][22]+
 BeF416*s->dpt[1][22]+BeF616*s->dpt[3][22]);
  OpM317_1 = -(OpM216_1*S17-OpM315_1*C17);
  AlM117_1 = AlM115_1*C16+AlM214_1*S16+OpM216_1*s->dpt[3][22]-OpM315_1*s->dpt[2][22];
  AlM317_1 = C17*(AlM315_1+OpM116_1*s->dpt[2][22]-OpM216_1*s->dpt[1][22])-S17*(AlM216_1-OpM116_1*s->dpt[3][22]+OpM315_1*
 s->dpt[1][22]);
  ...
  AlM117_5 = AlM115_5*C16+AlM214_5*S16+OpM216_5*s->dpt[3][22]-OpM315_5*s->dpt[2][22];
  AlM317_5 = C17*(AlM315_5+OpM116_5*s->dpt[2][22]-OpM216_5*s->dpt[1][22])-S17*(AlM216_5-OpM116_5*s->dpt[3][22]+OpM315_5*
 s->dpt[1][22]);
  OpM317_6 = -(OpM216_6*S17-OpM315_6*C17);
  AlM117_6 = AlM115_6*C16+AlM214_6*S16+OpM216_6*s->dpt[3][22]-OpM315_6*s->dpt[2][22];
  AlM317_6 = C17*(AlM315_6+OpM116_6*s->dpt[2][22]-OpM216_6*s->dpt[1][22])-S17*(AlM216_6-OpM116_6*s->dpt[3][22]+OpM315_6*
 s->dpt[1][22]);
  OpM317_7 = -(OpM216_7*S17-OpM315_7*C17);
  AlM117_7 = AlM115_7*C16+AlM214_7*S16+OpM216_7*s->dpt[3][22]-OpM315_7*s->dpt[2][22];
  AlM317_7 = C17*(AlM315_7+OpM116_7*s->dpt[2][22]-OpM216_7*s->dpt[1][22])-S17*(AlM216_7-OpM116_7*s->dpt[3][22]+OpM315_7*
 s->dpt[1][22]);
  OpM317_11 = -(OpM216_11*S17-OpM315_11*C17);
  AlM117_11 = AlM115_11*C16+OpM216_11*s->dpt[3][22]-OpM315_11*s->dpt[2][22];
  AlM317_11 = C17*(AlM315_11+OpM116_11*s->dpt[2][22]-OpM216_11*s->dpt[1][22])-S17*(AlM216_11-OpM116_11*s->dpt[3][22]+
 OpM315_11*s->dpt[1][22]);
  OpM317_13 = -(OpM216_13*S17-S15*C17);
  AlM117_13 = AlM115_13*C16+AlM214_13*S16+OpM216_13*s->dpt[3][22]-s->dpt[2][22]*S15;
  AlM317_13 = C17*(AlM315_13+OpM116_13*s->dpt[2][22]-OpM216_13*s->dpt[1][22])-S17*(AlM216_13-OpM116_13*s->dpt[3][22]+
 s->dpt[1][22]*S15);
  OpM317_14 = -(OpM216_14*S17-S15*C17);
  AlM117_14 = OpM216_14*s->dpt[3][22]-s->dpt[2][22]*S15;
  AlM317_14 = C17*(OpM116_14*s->dpt[2][22]-OpM216_14*s->dpt[1][22])+S17*(OpM116_14*s->dpt[3][22]-s->dpt[1][22]*S15);
  OpM317_15 = -C16*S17;
  AlM117_15 = s->dpt[3][22]*C16;
  AlM317_15 = s->dpt[3][22]*S16*S17-C17*(s->dpt[1][22]*C16-s->dpt[2][22]*S16);
  AlM317_16 = -s->dpt[1][22]*S17;
...
// Forward Kinematics 
  ...
  BeF819 = OpF111+OM219*OM319;
  AlF219 = C19*(AlF211+BS511*s->dpt[2][14]+BeF611*s->dpt[3][14])+S19*(AlF311+BS911*s->dpt[3][14]+BeF811*s->dpt[2][14]);
  AlF319 = C19*(AlF311+BS911*s->dpt[3][14]+BeF811*s->dpt[2][14])-S19*(AlF211+BS511*s->dpt[2][14]+BeF611*s->dpt[3][14]);
  OpM219_1 = OpM311_1*S19+C19*S6;
  OpM319_1 = OpM311_1*C19-S19*S6;
  AlM219_1 = C19*(AlM211_1-OpM111_1*s->dpt[3][14])+S19*(AlM311_1+OpM111_1*s->dpt[2][14]);
  AlM319_1 = C19*(AlM311_1+OpM111_1*s->dpt[2][14])-S19*(AlM211_1-OpM111_1*s->dpt[3][14]);
  ...
  AlM219_5 = C19*(AlM211_5-OpM111_5*s->dpt[3][14])+S19*(AlM311_5+OpM111_5*s->dpt[2][14]);
  AlM319_5 = C19*(AlM311_5+OpM111_5*s->dpt[2][14])-S19*(AlM211_5-OpM111_5*s->dpt[3][14]);
  AlM219_6 = s->dpt[2][14]*C11p7*S19+C19*(AlM211_6-s->dpt[3][14]*C11p7);
  AlM319_6 = s->dpt[2][14]*C11p7*C19-S19*(AlM211_6-s->dpt[3][14]*C11p7);
  ...
  AlF120 = AlF111+BeF211*s->dpt[2][14]+BeF311*s->dpt[3][14]-s->dpt[2][25]*(OpF319-OM119*OM219);
  AlF220 = C20*(AlF219+BS519*s->dpt[2][25])+S20*(AlF319+BeF819*s->dpt[2][25]);
  AlF320 = C20*(AlF319+BeF819*s->dpt[2][25])-S20*(AlF219+BS519*s->dpt[2][25]);
  OpM220_1 = OpM219_1*C20+OpM319_1*S20;
  OpM320_1 = -(OpM219_1*S20-OpM319_1*C20);
  AlM120_1 = AlM111_1-OpM311_1*s->dpt[2][14]-OpM319_1*s->dpt[2][25]+s->dpt[3][14]*S6;
  AlM220_1 = AlM219_1*C20+S20*(AlM319_1+OpM111_1*s->dpt[2][25]);
  AlM320_1 = -(AlM219_1*S20-C20*(AlM319_1+OpM111_1*s->dpt[2][25]));
  ...
  AlM120_5 = AlM111_5-OpM311_5*s->dpt[2][14]-OpM319_5*s->dpt[2][25]+s->dpt[3][14]*S6;
  AlM220_5 = AlM219_5*C20+S20*(AlM319_5+OpM111_5*s->dpt[2][25]);
  AlM320_5 = -(AlM219_5*S20-C20*(AlM319_5+OpM111_5*s->dpt[2][25]));
  OpM220_6 = S11p7*S19p20;
  OpM320_6 = S11p7*C19p20;
  AlM120_6 = -S11p7*(s->dpt[2][14]+s->dpt[2][25]*C19);
  AlM220_6 = AlM219_6*C20+S20*(AlM319_6+s->dpt[2][25]*C11p7);
  AlM320_6 = -(AlM219_6*S20-C20*(AlM319_6+s->dpt[2][25]*C11p7));
  AlM120_7 = AlM111_7+s->dpt[3][14]+s->dpt[2][25]*S19;
  AlM220_7 = AlM219_7*C20+AlM319_7*S20;
  AlM320_7 = -(AlM219_7*S20-AlM319_7*C20);
  AlM120_11 = s->dpt[3][14]+s->dpt[2][25]*S19;
  AlM220_19 = s->dpt[2][25]*S20;
  AlM320_19 = s->dpt[2][25]*C20;
  ...
  AlF123 = AlF121*C22+AlF220*S22-s->dpt[1][29]*(OM222*OM222+OM322*OM322)+s->dpt[2][29]*(BS222-OpF321)+s->dpt[3][29]*(
 BS322+OpF222);
  AlF323 = C23*(AlF321+BS922*s->dpt[3][29]+BeF722*s->dpt[1][29]+BeF822*s->dpt[2][29])-S23*(AlF222+BS522*s->dpt[2][29]+
 BeF422*s->dpt[1][29]+BeF622*s->dpt[3][29]);
  OpM323_1 = -(OpM222_1*S23-OpM321_1*C23);
  AlM123_1 = AlM121_1*C22+AlM220_1*S22+OpM222_1*s->dpt[3][29]-OpM321_1*s->dpt[2][29];
  AlM323_1 = C23*(AlM321_1+OpM122_1*s->dpt[2][29]-OpM222_1*s->dpt[1][29])-S23*(AlM222_1-OpM122_1*s->dpt[3][29]+OpM321_1*
 s->dpt[1][29]);
  ...
  AlM123_5 = AlM121_5*C22+AlM220_5*S22+OpM222_5*s->dpt[3][29]-OpM321_5*s->dpt[2][29];
  AlM323_5 = C23*(AlM321_5+OpM122_5*s->dpt[2][29]-OpM222_5*s->dpt[1][29])-S23*(AlM222_5-OpM122_5*s->dpt[3][29]+OpM321_5*
 s->dpt[1][29]);
  OpM323_6 = -(OpM222_6*S23-OpM321_6*C23);
  AlM123_6 = AlM121_6*C22+AlM220_6*S22+OpM222_6*s->dpt[3][29]-OpM321_6*s->dpt[2][29];
  AlM323_6 = C23*(AlM321_6+OpM122_6*s->dpt[2][29]-OpM222_6*s->dpt[1][29])-S23*(AlM222_6-OpM122_6*s->dpt[3][29]+OpM321_6*
 s->dpt[1][29]);
  OpM323_7 = -(OpM222_7*S23-OpM321_7*C23);
  AlM123_7 = AlM121_7*C22+AlM220_7*S22+OpM222_7*s->dpt[3][29]-OpM321_7*s->dpt[2][29];
  AlM323_7 = C23*(AlM321_7+OpM122_7*s->dpt[2][29]-OpM222_7*s->dpt[1][29])-S23*(AlM222_7-OpM122_7*s->dpt[3][29]+OpM321_7*
 s->dpt[1][29]);
  OpM323_11 = -(OpM222_11*S23-OpM321_11*C23);
  AlM123_11 = AlM121_11*C22+OpM222_11*s->dpt[3][29]-OpM321_11*s->dpt[2][29];
  AlM323_11 = C23*(AlM321_11+OpM122_11*s->dpt[2][29]-OpM222_11*s->dpt[1][29])-S23*(AlM222_11-OpM122_11*s->dpt[3][29]+
 OpM321_11*s->dpt[1][29]);
  OpM323_19 = -(OpM222_19*S23-S21*C23);
  AlM123_19 = AlM121_19*C22+AlM220_19*S22+OpM222_19*s->dpt[3][29]-s->dpt[2][29]*S21;
  AlM323_19 = C23*(AlM321_19+OpM122_19*s->dpt[2][29]-OpM222_19*s->dpt[1][29])-S23*(AlM222_19-OpM122_19*s->dpt[3][29]+
 s->dpt[1][29]*S21);
  OpM323_20 = -(OpM222_20*S23-S21*C23);
  AlM123_20 = OpM222_20*s->dpt[3][29]-s->dpt[2][29]*S21;
  AlM323_20 = C23*(OpM122_20*s->dpt[2][29]-OpM222_20*s->dpt[1][29])+S23*(OpM122_20*s->dpt[3][29]-s->dpt[1][29]*S21);
  OpM323_21 = -C22*S23;
  AlM123_21 = s->dpt[3][29]*C22;
  AlM323_21 = s->dpt[3][29]*S22*S23-C23*(s->dpt[1][29]*C22-s->dpt[2][29]*S22);
  AlM323_22 = -s->dpt[1][29]*S23;
...
// Backward Dynamics 
  ...
  FA218 = -(s->frc[2][18]-s->m[18]*(C17*(AlF216+BS516*s->dpt[2][22]+BeF416*s->dpt[1][22]+BeF616*s->dpt[3][22])+S17*(
 AlF315+BS916*s->dpt[3][22]+BeF716*s->dpt[1][22]+BeF816*s->dpt[2][22])));
 ...
 s->In[5][18]));
  ...
  FB218_1 = s->m[18]*(C17*(AlM216_1-OpM116_1*s->dpt[3][22]+OpM315_1*s->dpt[1][22])+S17*(AlM315_1+OpM116_1*s->dpt[2][22]-
 OpM216_1*s->dpt[1][22]));
  ...
  FB218_5 = s->m[18]*(C17*(AlM216_5-OpM116_5*s->dpt[3][22]+OpM315_5*s->dpt[1][22])+S17*(AlM315_5+OpM116_5*s->dpt[2][22]-
 OpM216_5*s->dpt[1][22]));
  ...
  FB218_6 = s->m[18]*(C17*(AlM216_6-OpM116_6*s->dpt[3][22]+OpM315_6*s->dpt[1][22])+S17*(AlM315_6+OpM116_6*s->dpt[2][22]-
 OpM216_6*s->dpt[1][22]));
  ...
  FB218_7 = s->m[18]*(C17*(AlM216_7-OpM116_7*s->dpt[3][22]+OpM315_7*s->dpt[1][22])+S17*(AlM315_7+OpM116_7*s->dpt[2][22]-
 OpM216_7*s->dpt[1][22]));
  ...
  FB218_11 = s->m[18]*(C17*(AlM216_11-OpM116_11*s->dpt[3][22]+OpM315_11*s->dpt[1][22])+S17*(AlM315_11+OpM116_11*
 s->dpt[2][22]-OpM216_11*s->dpt[1][22]));
  ...
  FB218_13 = s->m[18]*(C17*(AlM216_13-OpM116_13*s->dpt[3][22]+s->dpt[1][22]*S15)+S17*(AlM315_13+OpM116_13*s->dpt[2][22]-
 OpM216_13*s->dpt[1][22]));
  ...
  FB218_14 = -s->m[18]*(C17*(OpM116_14*s->dpt[3][22]-s->dpt[1][22]*S15)-S17*(OpM116_14*s->dpt[2][22]-OpM216_14*
 s->dpt[1][22]));
  ...
  FB218_15 = -s->m[18]*(s->dpt[3][22]*S16*C17+S17*(s->dpt[1][22]*C16-s->dpt[2][22]*S16));
  ...
  FB118_16 = -s->m[18]*(AlM317_16*S18+s->dpt[2][22]*C18);
  FB318_16 = s->m[18]*(AlM317_16*C18-s->dpt[2][22]*S18);
  ...
  CF116 = -(s->trq[1][16]-CF17_118-s->dpt[2][22]*(FA218*S17+FF17_318*C17)+s->dpt[3][22]*(FA218*C17-FF17_318*S17));
  CF216 = -(s->trq[2][16]+CF17_318*S17-CF218*C17-FF17_118*s->dpt[3][22]+s->dpt[1][22]*(FA218*S17+FF17_318*C17));
  CF316 = -(s->trq[3][16]-CF17_318*C17-CF218*S17+FF17_118*s->dpt[2][22]-s->dpt[1][22]*(FA218*C17-FF17_318*S17));
  FM161_217 = FB218_1*C17-FM171_318*S17;
  FM161_317 = FB218_1*S17+FM171_318*C17;
  CM161_117 = CM171_118+s->dpt[2][22]*(FB218_1*S17+FM171_318*C17)-s->dpt[3][22]*(FB218_1*C17-FM171_318*S17);
  CM161_217 = -(CM171_318*S17-CM218_1*C17-FM171_118*s->dpt[3][22]+s->dpt[1][22]*(FB218_1*S17+FM171_318*C17));
  CM161_317 = CM171_318*C17+CM218_1*S17-FM171_118*s->dpt[2][22]+s->dpt[1][22]*(FB218_1*C17-FM171_318*S17);
  FM162_217 = FB218_2*C17-FM172_318*S17;
  FM162_317 = FB218_2*S17+FM172_318*C17;
  CM162_117 = s->dpt[2][22]*(FB218_2*S17+FM172_318*C17)-s->dpt[3][22]*(FB218_2*C17-FM172_318*S17);
  CM162_217 = FM172_118*s->dpt[3][22]-s->dpt[1][22]*(FB218_2*S17+FM172_318*C17);
  CM162_317 = -(FM172_118*s->dpt[2][22]-s->dpt[1][22]*(FB218_2*C17-FM172_318*S17));
  FM163_217 = FB218_3*C17-FM173_318*S17;
  FM163_317 = FB218_3*S17+FM173_318*C17;
  CM163_117 = s->dpt[2][22]*(FB218_3*S17+FM173_318*C17)-s->dpt[3][22]*(FB218_3*C17-FM173_318*S17);
  CM163_217 = FM173_118*s->dpt[3][22]-s->dpt[1][22]*(FB218_3*S17+FM173_318*C17);
  CM163_317 = -(FM173_118*s->dpt[2][22]-s->dpt[1][22]*(FB218_3*C17-FM173_318*S17));
  FM164_217 = FB218_4*C17-FM174_318*S17;
  FM164_317 = FB218_4*S17+FM174_318*C17;
  CM164_117 = s->dpt[2][22]*(FB218_4*S17+FM174_318*C17)-s->dpt[3][22]*(FB218_4*C17-FM174_318*S17);
  CM164_217 = FM174_118*s->dpt[3][22]-s->dpt[1][22]*(FB218_4*S17+FM174_318*C17);
  CM164_317 = -(FM174_118*s->dpt[2][22]-s->dpt[1][22]*(FB218_4*C17-FM174_318*S17));
  FM165_217 = FB218_5*C17-FM175_318*S17;
  FM165_317 = FB218_5*S17+FM175_318*C17;
  CM165_117 = CM175_118+s->dpt[2][22]*(FB218_5*S17+FM175_318*C17)-s->dpt[3][22]*(FB218_5*C17-FM175_318*S17);
  CM165_217 = -(CM175_318*S17-CM218_5*C17-FM175_118*s->dpt[3][22]+s->dpt[1][22]*(FB218_5*S17+FM175_318*C17));
  CM165_317 = CM175_318*C17+CM218_5*S17-FM175_118*s->dpt[2][22]+s->dpt[1][22]*(FB218_5*C17-FM175_318*S17);
  FM166_217 = FB218_6*C17-FM176_318*S17;
  FM166_317 = FB218_6*S17+FM176_318*C17;
  CM166_117 = CM176_118+s->dpt[2][22]*(FB218_6*S17+FM176_318*C17)-s->dpt[3][22]*(FB218_6*C17-FM176_318*S17);
  CM166_217 = -(CM176_318*S17-CM218_6*C17-FM176_118*s->dpt[3][22]+s->dpt[1][22]*(FB218_6*S17+FM176_318*C17));
  CM166_317 = CM176_318*C17+CM218_6*S17-FM176_118*s->dpt[2][22]+s->dpt[1][22]*(FB218_6*C17-FM176_318*S17);
  FM167_217 = FB218_7*C17-FM177_318*S17;
  FM167_317 = FB218_7*S17+FM177_318*C17;
  CM167_117 = CM177_118+s->dpt[2][22]*(FB218_7*S17+FM177_318*C17)-s->dpt[3][22]*(FB218_7*C17-FM177_318*S17);
  CM167_217 = -(CM177_318*S17-CM218_7*C17-FM177_118*s->dpt[3][22]+s->dpt[1][22]*(FB218_7*S17+FM177_318*C17));
  CM167_317 = CM177_318*C17+CM218_7*S17-FM177_118*s->dpt[2][22]+s->dpt[1][22]*(FB218_7*C17-FM177_318*S17);
  FM1611_217 = FB218_11*C17-FM1711_318*S17;
  FM1611_317 = FB218_11*S17+FM1711_318*C17;
  CM1611_117 = CM1711_118+s->dpt[2][22]*(FB218_11*S17+FM1711_318*C17)-s->dpt[3][22]*(FB218_11*C17-FM1711_318*S17);
  CM1611_217 = -(CM1711_318*S17-CM218_11*C17-FM1711_118*s->dpt[3][22]+s->dpt[1][22]*(FB218_11*S17+FM1711_318*C17));
  CM1611_317 = CM1711_318*C17+CM218_11*S17-FM1711_118*s->dpt[2][22]+s->dpt[1][22]*(FB218_11*C17-FM1711_318*S17);
  FM1613_217 = FB218_13*C17-FM1713_318*S17;
  CM1613_117 = CM1713_118+s->dpt[2][22]*(FB218_13*S17+FM1713_318*C17)-s->dpt[3][22]*(FB218_13*C17-FM1713_318*S17);
  CM1613_217 = -(CM1713_318*S17-CM218_13*C17-FM1713_118*s->dpt[3][22]+s->dpt[1][22]*(FB218_13*S17+FM1713_318*C17));
  CM1613_317 = CM1713_318*C17+CM218_13*S17-FM1713_118*s->dpt[2][22]+s->dpt[1][22]*(FB218_13*C17-FM1713_318*S17);
  CM1614_117 = CM1714_118+s->dpt[2][22]*(FB218_14*S17+FM1714_318*C17)-s->dpt[3][22]*(FB218_14*C17-FM1714_318*S17);
  CM1614_217 = -(CM1714_318*S17-CM218_14*C17-FM1714_118*s->dpt[3][22]+s->dpt[1][22]*(FB218_14*S17+FM1714_318*C17));
  CM1614_317 = CM1714_318*C17+CM218_14*S17-FM1714_118*s->dpt[2][22]+s->dpt[1][22]*(FB218_14*C17-FM1714_318*S17);
  CM1615_317 = CM1715_318*C17+CM218_15*S17-FM1715_118*s->dpt[2][22]+s->dpt[1][22]*(FB218_15*C17-FM1715_318*S17);
  CM1616_317 = CM218_16*S17+s->dpt[1][22]*(s->m[18]*s->dpt[1][22]*C17*C17+S17*(FB118_16*S18-FB318_16*C18))-s->dpt[2][22]
 *(FB118_16*C18+FB318_16*S18)-C17*(CM118_16*S18-CM318_16*C18);
  ...
  CM1515_216 = -(C16*(CM1715_318*S17-CM218_15*C17-FM1715_118*s->dpt[3][22]+s->dpt[1][22]*(FB218_15*S17+FM1715_318*C17))-
 S16*(CM1715_118+s->dpt[2][22]*(FB218_15*S17+FM1715_318*C17)-s->dpt[3][22]*(FB218_15*C17-FM1715_318*S17)));
  ...
  CF113 = -(s->trq[1][13]-CF14_115-s->dpt[2][18]*(FF14_315*C14+FF15_216*S14));
  CF213 = -(s->trq[2][13]+CF14_315*S14-CF15_216*C14);
  CF313 = -(s->trq[3][13]-CF14_315*C14-CF15_216*S14+FF14_115*s->dpt[2][18]);
  FM131_214 = -(FM141_315*S14-FM151_216*C14);
  FM131_314 = FM141_315*C14+FM151_216*S14;
  CM131_114 = CM141_115+s->dpt[2][18]*(FM141_315*C14+FM151_216*S14);
  CM131_214 = -(CM141_315*S14-CM151_216*C14);
  CM131_314 = CM141_315*C14+CM151_216*S14-FM141_115*s->dpt[2][18];
  FM132_214 = -(FM142_315*S14-FM152_216*C14);
  FM132_314 = FM142_315*C14+FM152_216*S14;
  CM132_114 = CM142_115+s->dpt[2][18]*(FM142_315*C14+FM152_216*S14);
  CM132_214 = -(CM142_315*S14-CM152_216*C14);
  CM132_314 = CM142_315*C14+CM152_216*S14-FM142_115*s->dpt[2][18];
  FM133_214 = -(FM143_315*S14-FM153_216*C14);
  FM133_314 = FM143_315*C14+FM153_216*S14;
  CM133_114 = CM143_115+s->dpt[2][18]*(FM143_315*C14+FM153_216*S14);
  CM133_214 = -(CM143_315*S14-CM153_216*C14);
  CM133_314 = CM143_315*C14+CM153_216*S14-FM143_115*s->dpt[2][18];
  FM134_214 = -(FM144_315*S14-FM154_216*C14);
  FM134_314 = FM144_315*C14+FM154_216*S14;
  CM134_114 = CM144_115+s->dpt[2][18]*(FM144_315*C14+FM154_216*S14);
  CM134_214 = -(CM144_315*S14-CM154_216*C14);
  CM134_314 = CM144_315*C14+CM154_216*S14-FM144_115*s->dpt[2][18];
  FM135_214 = -(FM145_315*S14-FM155_216*C14);
  FM135_314 = FM145_315*C14+FM155_216*S14;
  CM135_114 = CM145_115+s->dpt[2][18]*(FM145_315*C14+FM155_216*S14);
  CM135_214 = -(CM145_315*S14-CM155_216*C14);
  CM135_314 = CM145_315*C14+CM155_216*S14-FM145_115*s->dpt[2][18];
  FM136_214 = -(FM146_315*S14-FM156_216*C14);
  FM136_314 = FM146_315*C14+FM156_216*S14;
  CM136_114 = CM146_115+s->dpt[2][18]*(FM146_315*C14+FM156_216*S14);
  CM136_214 = -(CM146_315*S14-CM156_216*C14);
  CM136_314 = CM146_315*C14+CM156_216*S14-FM146_115*s->dpt[2][18];
  CM137_114 = CM147_115+s->dpt[2][18]*(FM147_315*C14+FM157_216*S14);
  CM1311_114 = CM1411_115-s->dpt[2][18]*(C14*(FM1511_116*S15-FM1611_317*C15)-S14*(FM1611_217*C16+FM1711_118*S16));
  CM1313_114 = CM1413_115+s->dpt[2][18]*(C14*(C15*(FB218_13*S17+FM1713_318*C17)+S15*(FM1613_217*S16-FM1713_118*C16))+S14
 *(FM1613_217*C16+FM1713_118*S16));
...
// Backward Dynamics 
  ...
  FA224 = -(s->frc[2][24]-s->m[24]*(C23*(AlF222+BS522*s->dpt[2][29]+BeF422*s->dpt[1][29]+BeF622*s->dpt[3][29])+S23*(
 AlF321+BS922*s->dpt[3][29]+BeF722*s->dpt[1][29]+BeF822*s->dpt[2][29])));
 ...
 s->In[5][24]));
  ...
  FB224_1 = s->m[24]*(C23*(AlM222_1-OpM122_1*s->dpt[3][29]+OpM321_1*s->dpt[1][29])+S23*(AlM321_1+OpM122_1*s->dpt[2][29]-
 OpM222_1*s->dpt[1][29]));
  ...
  FB224_5 = s->m[24]*(C23*(AlM222_5-OpM122_5*s->dpt[3][29]+OpM321_5*s->dpt[1][29])+S23*(AlM321_5+OpM122_5*s->dpt[2][29]-
 OpM222_5*s->dpt[1][29]));
  ...
  FB224_6 = s->m[24]*(C23*(AlM222_6-OpM122_6*s->dpt[3][29]+OpM321_6*s->dpt[1][29])+S23*(AlM321_6+OpM122_6*s->dpt[2][29]-
 OpM222_6*s->dpt[1][29]));
  ...
  FB224_7 = s->m[24]*(C23*(AlM222_7-OpM122_7*s->dpt[3][29]+OpM321_7*s->dpt[1][29])+S23*(AlM321_7+OpM122_7*s->dpt[2][29]-
 OpM222_7*s->dpt[1][29]));
  ...
  FB224_11 = s->m[24]*(C23*(AlM222_11-OpM122_11*s->dpt[3][29]+OpM321_11*s->dpt[1][29])+S23*(AlM321_11+OpM122_11*
 s->dpt[2][29]-OpM222_11*s->dpt[1][29]));
  ...
  FB224_19 = s->m[24]*(C23*(AlM222_19-OpM122_19*s->dpt[3][29]+s->dpt[1][29]*S21)+S23*(AlM321_19+OpM122_19*s->dpt[2][29]-
 OpM222_19*s->dpt[1][29]));
  ...
  FB224_20 = -s->m[24]*(C23*(OpM122_20*s->dpt[3][29]-s->dpt[1][29]*S21)-S23*(OpM122_20*s->dpt[2][29]-OpM222_20*
 s->dpt[1][29]));
  ...
  FB224_21 = -s->m[24]*(s->dpt[3][29]*S22*C23+S23*(s->dpt[1][29]*C22-s->dpt[2][29]*S22));
  ...
  FB124_22 = -s->m[24]*(AlM323_22*S24+s->dpt[2][29]*C24);
  FB324_22 = s->m[24]*(AlM323_22*C24-s->dpt[2][29]*S24);
  ...
  CF122 = -(s->trq[1][22]-CF23_124-s->dpt[2][29]*(FA224*S23+FF23_324*C23)+s->dpt[3][29]*(FA224*C23-FF23_324*S23));
  CF222 = -(s->trq[2][22]-CF224*C23+CF23_324*S23-FF23_124*s->dpt[3][29]+s->dpt[1][29]*(FA224*S23+FF23_324*C23));
  CF322 = -(s->trq[3][22]-CF224*S23-CF23_324*C23+FF23_124*s->dpt[2][29]-s->dpt[1][29]*(FA224*C23-FF23_324*S23));
  FM221_223 = FB224_1*C23-FM231_324*S23;
  FM221_323 = FB224_1*S23+FM231_324*C23;
  CM221_123 = CM231_124+s->dpt[2][29]*(FB224_1*S23+FM231_324*C23)-s->dpt[3][29]*(FB224_1*C23-FM231_324*S23);
  CM221_223 = CM224_1*C23-CM231_324*S23+FM231_124*s->dpt[3][29]-s->dpt[1][29]*(FB224_1*S23+FM231_324*C23);
  CM221_323 = CM224_1*S23+CM231_324*C23-FM231_124*s->dpt[2][29]+s->dpt[1][29]*(FB224_1*C23-FM231_324*S23);
  FM222_223 = FB224_2*C23-FM232_324*S23;
  FM222_323 = FB224_2*S23+FM232_324*C23;
  CM222_123 = s->dpt[2][29]*(FB224_2*S23+FM232_324*C23)-s->dpt[3][29]*(FB224_2*C23-FM232_324*S23);
  CM222_223 = FM232_124*s->dpt[3][29]-s->dpt[1][29]*(FB224_2*S23+FM232_324*C23);
  CM222_323 = -(FM232_124*s->dpt[2][29]-s->dpt[1][29]*(FB224_2*C23-FM232_324*S23));
  FM223_223 = FB224_3*C23-FM233_324*S23;
  FM223_323 = FB224_3*S23+FM233_324*C23;
  CM223_123 = s->dpt[2][29]*(FB224_3*S23+FM233_324*C23)-s->dpt[3][29]*(FB224_3*C23-FM233_324*S23);
  CM223_223 = FM233_124*s->dpt[3][29]-s->dpt[1][29]*(FB224_3*S23+FM233_324*C23);
  CM223_323 = -(FM233_124*s->dpt[2][29]-s->dpt[1][29]*(FB224_3*C23-FM233_324*S23));
  FM224_223 = FB224_4*C23-FM234_324*S23;
  FM224_323 = FB224_4*S23+FM234_324*C23;
  CM224_123 = s->dpt[2][29]*(FB224_4*S23+FM234_324*C23)-s->dpt[3][29]*(FB224_4*C23-FM234_324*S23);
  CM224_223 = FM234_124*s->dpt[3][29]-s->dpt[1][29]*(FB224_4*S23+FM234_324*C23);
  CM224_323 = -(FM234_124*s->dpt[2][29]-s->dpt[1][29]*(FB224_4*C23-FM234_324*S23));
  FM225_223 = FB224_5*C23-FM235_324*S23;
  FM225_323 = FB224_5*S23+FM235_324*C23;
  CM225_123 = CM235_124+s->dpt[2][29]*(FB224_5*S23+FM235_324*C23)-s->dpt[3][29]*(FB224_5*C23-FM235_324*S23);
  CM225_223 = CM224_5*C23-CM235_324*S23+FM235_124*s->dpt[3][29]-s->dpt[1][29]*(FB224_5*S23+FM235_324*C23);
  CM225_323 = CM224_5*S23+CM235_324*C23-FM235_124*s->dpt[2][29]+s->dpt[1][29]*(FB224_5*C23-FM235_324*S23);
  FM226_223 = FB224_6*C23-FM236_324*S23;
  FM226_323 = FB224_6*S23+FM236_324*C23;
  CM226_123 = CM236_124+s->dpt[2][29]*(FB224_6*S23+FM236_324*C23)-s->dpt[3][29]*(FB224_6*C23-FM236_324*S23);
  CM226_223 = CM224_6*C23-CM236_324*S23+FM236_124*s->dpt[3][29]-s->dpt[1][29]*(FB224_6*S23+FM236_324*C23);
  CM226_323 = CM224_6*S23+CM236_324*C23-FM236_124*s->dpt[2][29]+s->dpt[1][29]*(FB224_6*C23-FM236_324*S23);
  FM227_223 = FB224_7*C23-FM237_324*S23;
  FM227_323 = FB224_7*S23+FM237_324*C23;
  CM227_123 = CM237_124+s->dpt[2][29]*(FB224_7*S23+FM237_324*C23)-s->dpt[3][29]*(FB224_7*C23-FM237_324*S23);
  CM227_223 = CM224_7*C23-CM237_324*S23+FM237_124*s->dpt[3][29]-s->dpt[1][29]*(FB224_7*S23+FM237_324*C23);
  CM227_323 = CM224_7*S23+CM237_324*C23-FM237_124*s->dpt[2][29]+s->dpt[1][29]*(FB224_7*C23-FM237_324*S23);
  FM2211_223 = FB224_11*C23-FM2311_324*S23;
  FM2211_323 = FB224_11*S23+FM2311_324*C23;
  CM2211_123 = CM2311_124+s->dpt[2][29]*(FB224_11*S23+FM2311_324*C23)-s->dpt[3][29]*(FB224_11*C23-FM2311_324*S23);
  CM2211_223 = CM224_11*C23-CM2311_324*S23+FM2311_124*s->dpt[3][29]-s->dpt[1][29]*(FB224_11*S23+FM2311_324*C23);
  CM2211_323 = CM224_11*S23+CM2311_324*C23-FM2311_124*s->dpt[2][29]+s->dpt[1][29]*(FB224_11*C23-FM2311_324*S23);
  FM2219_223 = FB224_19*C23-FM2319_324*S23;
  CM2219_123 = CM2319_124+s->dpt[2][29]*(FB224_19*S23+FM2319_324*C23)-s->dpt[3][29]*(FB224_19*C23-FM2319_324*S23);
  CM2219_223 = CM224_19*C23-CM2319_324*S23+FM2319_124*s->dpt[3][29]-s->dpt[1][29]*(FB224_19*S23+FM2319_324*C23);
  CM2219_323 = CM224_19*S23+CM2319_324*C23-FM2319_124*s->dpt[2][29]+s->dpt[1][29]*(FB224_19*C23-FM2319_324*S23);
  CM2220_123 = CM2320_124+s->dpt[2][29]*(FB224_20*S23+FM2320_324*C23)-s->dpt[3][29]*(FB224_20*C23-FM2320_324*S23);
  CM2220_223 = CM224_20*C23-CM2320_324*S23+FM2320_124*s->dpt[3][29]-s->dpt[1][29]*(FB224_20*S23+FM2320_324*C23);
  CM2220_323 = CM224_20*S23+CM2320_324*C23-FM2320_124*s->dpt[2][29]+s->dpt[1][29]*(FB224_20*C23-FM2320_324*S23);
  CM2221_323 = CM224_21*S23+CM2321_324*C23-FM2321_124*s->dpt[2][29]+s->dpt[1][29]*(FB224_21*C23-FM2321_324*S23);
  CM2222_323 = CM224_22*S23+s->dpt[1][29]*(s->m[24]*s->dpt[1][29]*C23*C23+S23*(FB124_22*S24-FB324_22*C24))-s->dpt[2][29]
 *(FB124_22*C24+FB324_22*S24)-C23*(CM124_22*S24-CM324_22*C24);
  ...
  CM2121_222 = C22*(CM224_21*C23-CM2321_324*S23+FM2321_124*s->dpt[3][29]-s->dpt[1][29]*(FB224_21*S23+FM2321_324*C23))+
 S22*(CM2321_124+s->dpt[2][29]*(FB224_21*S23+FM2321_324*C23)-s->dpt[3][29]*(FB224_21*C23-FM2321_324*S23));
  ...
  CF119 = -(s->trq[1][19]-CF20_121-s->dpt[2][25]*(FF20_321*C20+FF21_222*S20));
  CF219 = -(s->trq[2][19]+CF20_321*S20-CF21_222*C20);
  CF319 = -(s->trq[3][19]-CF20_321*C20-CF21_222*S20+FF20_121*s->dpt[2][25]);
  FM191_220 = -(FM201_321*S20-FM211_222*C20);
  FM191_320 = FM201_321*C20+FM211_222*S20;
  CM191_120 = CM201_121+s->dpt[2][25]*(FM201_321*C20+FM211_222*S20);
  CM191_220 = -(CM201_321*S20-CM211_222*C20);
  CM191_320 = CM201_321*C20+CM211_222*S20-FM201_121*s->dpt[2][25];
  FM192_220 = -(FM202_321*S20-FM212_222*C20);
  FM192_320 = FM202_321*C20+FM212_222*S20;
  CM192_120 = CM202_121+s->dpt[2][25]*(FM202_321*C20+FM212_222*S20);
  CM192_220 = -(CM202_321*S20-CM212_222*C20);
  CM192_320 = CM202_321*C20+CM212_222*S20-FM202_121*s->dpt[2][25];
  FM193_220 = -(FM203_321*S20-FM213_222*C20);
  FM193_320 = FM203_321*C20+FM213_222*S20;
  CM193_120 = CM203_121+s->dpt[2][25]*(FM203_321*C20+FM213_222*S20);
  CM193_220 = -(CM203_321*S20-CM213_222*C20);
  CM193_320 = CM203_321*C20+CM213_222*S20-FM203_121*s->dpt[2][25];
  FM194_220 = -(FM204_321*S20-FM214_222*C20);
  FM194_320 = FM204_321*C20+FM214_222*S20;
  CM194_120 = CM204_121+s->dpt[2][25]*(FM204_321*C20+FM214_222*S20);
  CM194_220 = -(CM204_321*S20-CM214_222*C20);
  CM194_320 = CM204_321*C20+CM214_222*S20-FM204_121*s->dpt[2][25];
  FM195_220 = -(FM205_321*S20-FM215_222*C20);
  FM195_320 = FM205_321*C20+FM215_222*S20;
  CM195_120 = CM205_121+s->dpt[2][25]*(FM205_321*C20+FM215_222*S20);
  CM195_220 = -(CM205_321*S20-CM215_222*C20);
  CM195_320 = CM205_321*C20+CM215_222*S20-FM205_121*s->dpt[2][25];
  FM196_220 = -(FM206_321*S20-FM216_222*C20);
  FM196_320 = FM206_321*C20+FM216_222*S20;
  CM196_120 = CM206_121+s->dpt[2][25]*(FM206_321*C20+FM216_222*S20);
  CM196_220 = -(CM206_321*S20-CM216_222*C20);
  CM196_320 = CM206_321*C20+CM216_222*S20-FM206_121*s->dpt[2][25];
  CM197_120 = CM207_121+s->dpt[2][25]*(FM207_321*C20+FM217_222*S20);
  CM1911_120 = CM2011_121-s->dpt[2][25]*(C20*(FM2111_122*S21-FM2211_323*C21)-S20*(FM2211_223*C22+FM2311_124*S22));
  CM1919_120 = CM2019_121+s->dpt[2][25]*(C20*(C21*(FB224_19*S23+FM2319_324*C23)+S21*(FM2219_223*S22-FM2319_124*C22))+S20
 *(FM2219_223*C22+FM2319_124*S22));
...
// Backward Dynamics 
 ...
 s->dpt[3][12]*(s->frc[1][10]*C10-s->frc[2][10]*S10));
...
// Backward Dynamics 
  ...
  CF111 = -(s->trq[1][11]-CF112-CF113-CF119-s->dpt[2][13]*(FF213*S13+FF313*C13)-s->dpt[2][14]*(FF219*S19+FF319*C19)+
 s->dpt[3][13]*(FF213*C13-FF313*S13)+s->dpt[3][14]*(FF219*C19-FF319*S19));
  CF211 = -(s->trq[2][11]-CF212*C12-CF213*C13-CF219*C19+CF312*S12+CF313*S13+CF319*S19-FF113*s->dpt[3][13]-FF119*
 s->dpt[3][14]);
  CF311 = -(s->trq[3][11]-CF212*S12-CF213*S13-CF219*S19-CF312*C12-CF313*C13-CF319*C19+FF113*s->dpt[2][13]+FF119*
 s->dpt[2][14]);
  ...
  CM111_1 = CM112_1+CM131_114+CM191_120+s->dpt[2][13]*(FM131_214*S13+FM131_314*C13)+s->dpt[2][14]*(FM191_220*S19+
 FM191_320*C19)-s->dpt[3][13]*(FM131_214*C13-FM131_314*S13)-s->dpt[3][14]*(FM191_220*C19-FM191_320*S19);
  CM211_1 = CM131_214*C13-CM131_314*S13+CM191_220*C19-CM191_320*S19+CM212_1*C12+FM141_115*s->dpt[3][13]+FM201_121*
 s->dpt[3][14];
  CM311_1 = CM131_214*S13+CM131_314*C13+CM191_220*S19+CM191_320*C19+CM212_1*S12-FM141_115*s->dpt[2][13]-FM201_121*
 s->dpt[2][14];
  ...
  CM111_2 = CM112_2+CM132_114+CM192_120+s->dpt[2][13]*(FM132_214*S13+FM132_314*C13)+s->dpt[2][14]*(FM192_220*S19+
 FM192_320*C19)-s->dpt[3][13]*(FM132_214*C13-FM132_314*S13)-s->dpt[3][14]*(FM192_220*C19-FM192_320*S19);
  CM211_2 = CM132_214*C13-CM132_314*S13+CM192_220*C19-CM192_320*S19+CM212_2*C12+FM142_115*s->dpt[3][13]+FM202_121*
 s->dpt[3][14];
  CM311_2 = CM132_214*S13+CM132_314*C13+CM192_220*S19+CM192_320*C19+CM212_2*S12-FM142_115*s->dpt[2][13]-FM202_121*
 s->dpt[2][14];
  ...
  CM111_3 = CM112_3+CM133_114+CM193_120+s->dpt[2][13]*(FM133_214*S13+FM133_314*C13)+s->dpt[2][14]*(FM193_220*S19+
 FM193_320*C19)-s->dpt[3][13]*(FM133_214*C13-FM133_314*S13)-s->dpt[3][14]*(FM193_220*C19-FM193_320*S19);
  CM211_3 = CM133_214*C13-CM133_314*S13+CM193_220*C19-CM193_320*S19+CM212_3*C12+FM143_115*s->dpt[3][13]+FM203_121*
 s->dpt[3][14];
  CM311_3 = CM133_214*S13+CM133_314*C13+CM193_220*S19+CM193_320*C19+CM212_3*S12-FM143_115*s->dpt[2][13]-FM203_121*
 s->dpt[2][14];
  ...
  CM111_4 = CM112_4+CM134_114+CM194_120+s->dpt[2][13]*(FM134_214*S13+FM134_314*C13)+s->dpt[2][14]*(FM194_220*S19+
 FM194_320*C19)-s->dpt[3][13]*(FM134_214*C13-FM134_314*S13)-s->dpt[3][14]*(FM194_220*C19-FM194_320*S19);
  CM211_4 = CM134_214*C13-CM134_314*S13+CM194_220*C19-CM194_320*S19+CM212_4*C12+FM144_115*s->dpt[3][13]+FM204_121*
 s->dpt[3][14];
  CM311_4 = CM134_214*S13+CM134_314*C13+CM194_220*S19+CM194_320*C19+CM212_4*S12-FM144_115*s->dpt[2][13]-FM204_121*
 s->dpt[2][14];
  ...
  CM111_5 = CM112_5+CM135_114+CM195_120+s->dpt[2][13]*(FM135_214*S13+FM135_314*C13)+s->dpt[2][14]*(FM195_220*S19+
 FM195_320*C19)-s->dpt[3][13]*(FM135_214*C13-FM135_314*S13)-s->dpt[3][14]*(FM195_220*C19-FM195_320*S19);
  CM211_5 = CM135_214*C13-CM135_314*S13+CM195_220*C19-CM195_320*S19+CM212_5*C12+FM145_115*s->dpt[3][13]+FM205_121*
 s->dpt[3][14];
  CM311_5 = CM135_214*S13+CM135_314*C13+CM195_220*S19+CM195_320*C19+CM212_5*S12-FM145_115*s->dpt[2][13]-FM205_121*
 s->dpt[2][14];
  ...
  CM111_6 = CM112_6+CM136_114+CM196_120+s->dpt[2][13]*(FM136_214*S13+FM136_314*C13)+s->dpt[2][14]*(FM196_220*S19+
 FM196_320*C19)-s->dpt[3][13]*(FM136_214*C13-FM136_314*S13)-s->dpt[3][14]*(FM196_220*C19-FM196_320*S19);
  CM211_6 = CM136_214*C13-CM136_314*S13+CM196_220*C19-CM196_320*S19+CM212_6*C12+FM146_115*s->dpt[3][13]+FM206_121*
 s->dpt[3][14];
  CM311_6 = CM136_214*S13+CM136_314*C13+CM196_220*S19+CM196_320*C19+CM212_6*S12-FM146_115*s->dpt[2][13]-FM206_121*
 s->dpt[2][14];
 ...
 FM217_222*S20)-S19*(FM207_321*S20-FM217_222*C20);
  CM211_7 = FM147_115*s->dpt[3][13]+FM207_121*s->dpt[3][14]+C12*(s->In[5][12]*C12+FB112_7*s->l[3][12])-C13*(CM147_315*
 S14-CM157_216*C14)-S13*(CM147_315*C14+CM157_216*S14-FM147_115*s->dpt[2][18])-C19*(CM207_321*S20-CM217_222*C20)-S19*(
 CM207_321*C20+CM217_222*S20-FM207_121*s->dpt[2][25]);
  CM211_11 = FM1411_115*s->dpt[3][13]+FM2011_121*s->dpt[3][14]+C12*C12*(s->In[5][12]+s->m[12]*s->l[3][12]*s->l[3][12])-
 C13*(CM1411_315*S14-CM1511_216*C14)-S13*(CM1411_315*C14+CM1511_216*S14-FM1411_115*s->dpt[2][18])-C19*(CM2011_321*S20-
 CM2111_222*C20)-S19*(CM2011_321*C20+CM2111_222*S20-FM2011_121*s->dpt[2][25]);
