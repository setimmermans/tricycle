...
// Forward Kinematics 
  ...
  AlF114 = AlF111+BeF211*s->dpt[2][12]+BeF311*s->dpt[3][12]-s->dpt[2][17]*(OpF313-OM113*OM213);
  AlF214 = C14*(AlF213+BS513*s->dpt[2][17])+S14*(AlF313+BeF813*s->dpt[2][17]);
  AlF314 = C14*(AlF313+BeF813*s->dpt[2][17])-S14*(AlF213+BS513*s->dpt[2][17]);
  OpM214_1 = OpM213_1*C14+OpM313_1*S14;
  OpM314_1 = -(OpM213_1*S14-OpM313_1*C14);
  AlM114_1 = AlM111_1-OpM311_1*s->dpt[2][12]-OpM313_1*s->dpt[2][17]+s->dpt[3][12]*S6;
  AlM214_1 = AlM213_1*C14+S14*(AlM313_1+OpM111_1*s->dpt[2][17]);
  AlM314_1 = -(AlM213_1*S14-C14*(AlM313_1+OpM111_1*s->dpt[2][17]));
  ...
  AlM114_5 = AlM111_5-OpM311_5*s->dpt[2][12]-OpM313_5*s->dpt[2][17]+s->dpt[3][12]*S6;
  AlM214_5 = AlM213_5*C14+S14*(AlM313_5+OpM111_5*s->dpt[2][17]);
  AlM314_5 = -(AlM213_5*S14-C14*(AlM313_5+OpM111_5*s->dpt[2][17]));
  OpM214_6 = S11p7*S13p14;
  OpM314_6 = S11p7*C13p14;
  AlM114_6 = -S11p7*(s->dpt[2][12]+s->dpt[2][17]*C13);
  AlM214_6 = AlM213_6*C14+S14*(AlM313_6+s->dpt[2][17]*C11p7);
  AlM314_6 = -(AlM213_6*S14-C14*(AlM313_6+s->dpt[2][17]*C11p7));
  AlM114_7 = AlM111_7+s->dpt[3][12]+s->dpt[2][17]*S13;
  AlM214_7 = AlM213_7*C14+AlM313_7*S14;
  AlM314_7 = -(AlM213_7*S14-AlM313_7*C14);
  AlM114_11 = s->dpt[3][12]+s->dpt[2][17]*S13;
  AlM214_13 = s->dpt[2][17]*S14;
  AlM314_13 = s->dpt[2][17]*C14;
...
// Forward Kinematics 
  ...
  AlF120 = AlF111+BeF211*s->dpt[2][13]+BeF311*s->dpt[3][13]-s->dpt[2][24]*(OpF319-OM119*OM219);
  AlF220 = C20*(AlF219+BS519*s->dpt[2][24])+S20*(AlF319+BeF819*s->dpt[2][24]);
  AlF320 = C20*(AlF319+BeF819*s->dpt[2][24])-S20*(AlF219+BS519*s->dpt[2][24]);
  OpM220_1 = OpM219_1*C20+OpM319_1*S20;
  OpM320_1 = -(OpM219_1*S20-OpM319_1*C20);
  AlM120_1 = AlM111_1-OpM311_1*s->dpt[2][13]-OpM319_1*s->dpt[2][24]+s->dpt[3][13]*S6;
  AlM220_1 = AlM219_1*C20+S20*(AlM319_1+OpM111_1*s->dpt[2][24]);
  AlM320_1 = -(AlM219_1*S20-C20*(AlM319_1+OpM111_1*s->dpt[2][24]));
  ...
  AlM120_5 = AlM111_5-OpM311_5*s->dpt[2][13]-OpM319_5*s->dpt[2][24]+s->dpt[3][13]*S6;
  AlM220_5 = AlM219_5*C20+S20*(AlM319_5+OpM111_5*s->dpt[2][24]);
  AlM320_5 = -(AlM219_5*S20-C20*(AlM319_5+OpM111_5*s->dpt[2][24]));
  OpM220_6 = S11p7*S19p20;
  OpM320_6 = S11p7*C19p20;
  AlM120_6 = -S11p7*(s->dpt[2][13]+s->dpt[2][24]*C19);
  AlM220_6 = AlM219_6*C20+S20*(AlM319_6+s->dpt[2][24]*C11p7);
  AlM320_6 = -(AlM219_6*S20-C20*(AlM319_6+s->dpt[2][24]*C11p7));
  AlM120_7 = AlM111_7+s->dpt[3][13]+s->dpt[2][24]*S19;
  AlM220_7 = AlM219_7*C20+AlM319_7*S20;
  AlM320_7 = -(AlM219_7*S20-AlM319_7*C20);
  AlM120_11 = s->dpt[3][13]+s->dpt[2][24]*S19;
  AlM220_19 = s->dpt[2][24]*S20;
  AlM320_19 = s->dpt[2][24]*C20;
 ...
 *(FB118_16*C18+FB318_16*S18)-C17*(CM118_16*S18-CM318_16*C18);
 ...
 S16*(CM1715_118+s->dpt[2][21]*(FB218_15*S17+FM1715_318*C17)-s->dpt[3][21]*(FB218_15*C17-FM1715_318*S17)));
  ...
  CF113 = -(s->trq[1][13]-CF14_115-s->dpt[2][17]*(FF14_315*C14+FF15_216*S14));
  ...
  CM131_114 = CM141_115+s->dpt[2][17]*(FM141_315*C14+FM151_216*S14);
  ...
  CM132_114 = CM142_115+s->dpt[2][17]*(FM142_315*C14+FM152_216*S14);
  ...
  CM133_114 = CM143_115+s->dpt[2][17]*(FM143_315*C14+FM153_216*S14);
  ...
  CM134_114 = CM144_115+s->dpt[2][17]*(FM144_315*C14+FM154_216*S14);
  ...
  CM135_114 = CM145_115+s->dpt[2][17]*(FM145_315*C14+FM155_216*S14);
  ...
  CM136_114 = CM146_115+s->dpt[2][17]*(FM146_315*C14+FM156_216*S14);
  CM136_214 = -(CM146_315*S14-CM156_216*C14);
  CM136_314 = CM146_315*C14+CM156_216*S14-FM146_115*s->dpt[2][17];
  CM137_114 = CM147_115+s->dpt[2][17]*(FM147_315*C14+FM157_216*S14);
  CM1311_114 = CM1411_115-s->dpt[2][17]*(C14*(FM1511_116*S15-FM1611_317*C15)-S14*(FM1611_217*C16+FM1711_118*S16));
  CM1313_114 = CM1413_115+s->dpt[2][17]*(C14*(C15*(FB218_13*S17+FM1713_318*C17)+S15*(FM1613_217*S16-FM1713_118*C16))+S14
 ...
 *(FB124_22*C24+FB324_22*S24)-C23*(CM124_22*S24-CM324_22*C24);
 ...
 S22*(CM2321_124+s->dpt[2][28]*(FB224_21*S23+FM2321_324*C23)-s->dpt[3][28]*(FB224_21*C23-FM2321_324*S23));
  ...
  CF119 = -(s->trq[1][19]-CF20_121-s->dpt[2][24]*(FF20_321*C20+FF21_222*S20));
  ...
  CM191_120 = CM201_121+s->dpt[2][24]*(FM201_321*C20+FM211_222*S20);
  ...
  CM192_120 = CM202_121+s->dpt[2][24]*(FM202_321*C20+FM212_222*S20);
  ...
  CM193_120 = CM203_121+s->dpt[2][24]*(FM203_321*C20+FM213_222*S20);
  ...
  CM194_120 = CM204_121+s->dpt[2][24]*(FM204_321*C20+FM214_222*S20);
  ...
  CM195_120 = CM205_121+s->dpt[2][24]*(FM205_321*C20+FM215_222*S20);
  ...
  CM196_120 = CM206_121+s->dpt[2][24]*(FM206_321*C20+FM216_222*S20);
  CM196_220 = -(CM206_321*S20-CM216_222*C20);
  CM196_320 = CM206_321*C20+CM216_222*S20-FM206_121*s->dpt[2][24];
  CM197_120 = CM207_121+s->dpt[2][24]*(FM207_321*C20+FM217_222*S20);
  CM1911_120 = CM2011_121-s->dpt[2][24]*(C20*(FM2111_122*S21-FM2211_323*C21)-S20*(FM2211_223*C22+FM2311_124*S22));
  CM1919_120 = CM2019_121+s->dpt[2][24]*(C20*(C21*(FB224_19*S23+FM2319_324*C23)+S21*(FM2219_223*S22-FM2319_124*C22))+S20
...
// Backward Dynamics 
 ...
 S14-CM157_216*C14)-S13*(CM147_315*C14+CM157_216*S14-FM147_115*s->dpt[2][17])-C19*(CM207_321*S20-CM217_222*C20)-S19*(
 CM207_321*C20+CM217_222*S20-FM207_121*s->dpt[2][24]);
  CM211_11 = FM1411_115*s->dpt[3][12]+FM2011_121*s->dpt[3][13]+C12*C12*(s->In[5][12]+s->m[12]*s->l[3][12]*s->l[3][12])-
 C13*(CM1411_315*S14-CM1511_216*C14)-S13*(CM1411_315*C14+CM1511_216*S14-FM1411_115*s->dpt[2][17])-C19*(CM2011_321*S20-
 CM2111_222*C20)-S19*(CM2011_321*C20+CM2111_222*S20-FM2011_121*s->dpt[2][24]);
