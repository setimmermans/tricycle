...
// Constraints and Constraints Jacobian 
  ...
  RL_3_214 = s->dpt[2][17]*C13-s->dpt[3][17]*S13;
...
//
  ...
  RL_7_114 = S11*(s->dpt[2][17]*S13+s->dpt[3][17]*C13);
  RL_7_214 = s->dpt[2][17]*C13-s->dpt[3][17]*S13;
  RL_7_314 = C11*(s->dpt[2][17]*S13+s->dpt[3][17]*C13);
  RL_7_139 = RO_7_715*s->dpt[3][22]+s->dpt[1][22]*(RO_7_414*S16-C16*(RO_7_714*S15-C11*C15));
  RL_7_239 = RO_7_815*s->dpt[3][22]+s->dpt[1][22]*(C13p14*S16+S13p14*S15*C16);
  RL_7_339 = RO_7_915*s->dpt[3][22]+s->dpt[1][22]*(RO_7_614*S16-C16*(RO_7_914*S15+S11*C15));
//
...
// Constraints and Constraints Jacobian 
  ...
  RL_1_120 = S11*(s->dpt[2][24]*S19+s->dpt[3][24]*C19);
  RL_1_220 = s->dpt[2][24]*C19-s->dpt[3][24]*S19;
  RL_1_320 = C11*(s->dpt[2][24]*S19+s->dpt[3][24]*C19);
  RL_1_133 = RO_1_721*s->dpt[3][27];
  RL_1_233 = RO_1_821*s->dpt[3][27];
  RL_1_333 = RO_1_921*s->dpt[3][27];
//
  RL_4_136 = RO_1_721*s->dpt[3][29]+s->dpt[1][29]*(RO_1_420*S22-C22*(RO_1_720*S21-C11*C21));
  RL_4_236 = RO_1_821*s->dpt[3][29]+s->dpt[1][29]*(C19p20*S22+S19p20*S21*C22);
  RL_4_336 = RO_1_921*s->dpt[3][29]+s->dpt[1][29]*(RO_1_620*S22-C22*(RO_1_920*S21+S11*C21));
//
...
//
  ...
  OR_1_220 = -(OM_1_119*RL_1_320-OM_1_319*RL_1_120);
...
//
  ...
  OR_3_214 = -(s->dpt[2][17]*S13+s->dpt[3][17]*C13)*(OM_3_113*C11-OM_3_313*S11);
...
//
  ...
  OR_7_214 = -(OM_7_113*RL_7_314-OM_7_313*RL_7_114);
...
//
  jdqd7 = (RL_1_220+RL_4_236-RL_5_237+s->dpt[2][13])*(Apqp_1_220-OM_1_122*OR_4_336+OM_1_322*OR_4_136+OM_5_126*OR_5_337-
 OM_5_326*OR_5_137-Ompqp_1_122*RL_4_336+Ompqp_1_322*RL_4_136)+(RL_1_120+RL_4_136-RL_5_137+s->dpt[1][5]-s->dpt[1][6]+
 s->dpt[3][13]*S11)*(Apqp_1_120+OM_1_222*OR_4_336-OM_1_322*OR_4_236+OM_5_326*OR_5_237+Ompqp_1_222*RL_4_336-Ompqp_1_322*
 RL_4_236)+(RL_1_320+RL_4_336-RL_5_337+s->dpt[3][5]-s->dpt[3][6]+s->dpt[3][13]*C11)*(Apqp_1_320+OM_1_122*OR_4_236-OM_1_222*
 OR_4_136-OM_5_126*OR_5_237+Ompqp_1_122*RL_4_236-Ompqp_1_222*RL_4_136)+(OR_5_137-VI_4_136)*(OR_5_137-VI_4_136)+(OR_5_237-
 VI_4_236)*(OR_5_237-VI_4_236)+(OR_5_337-VI_4_336)*(OR_5_337-VI_4_336);
//
  jdqd8 = -((OM_5_126*OR_6_338-OM_5_326*OR_6_138-OM_7_113*OR_7_314-OM_7_116*OR_7_339+OM_7_313*OR_7_114+OM_7_316*OR_7_139
 -Ompqp_7_116*RL_7_339+Ompqp_7_316*RL_7_139)*(RL_6_238-RL_7_214-RL_7_239-s->dpt[2][12])-(OM_5_126*OR_6_238-OM_7_113*OR_7_214-
 OM_7_116*OR_7_239+OM_7_216*OR_7_139-Ompqp_7_116*RL_7_239+Ompqp_7_216*RL_7_139)*(RL_6_338-RL_7_314-RL_7_339-s->dpt[3][5]+
 s->dpt[3][6]-s->dpt[3][12]*C11)-(OR_6_138-VI_7_139)*(OR_6_138-VI_7_139)-(OR_6_238-VI_7_239)*(OR_6_238-VI_7_239)-(OR_6_338-
 VI_7_339)*(OR_6_338-VI_7_339)+(OM_5_326*OR_6_238+OM_7_216*OR_7_339-OM_7_313*OR_7_214-OM_7_316*OR_7_239+Ompqp_7_216*RL_7_339-
 Ompqp_7_316*RL_7_239)*(RL_6_138-RL_7_114-RL_7_139-s->dpt[1][5]+s->dpt[1][6]-s->dpt[3][12]*S11));
//
...
//
 ...
 OR_11_243*qd[19])*(RL_10_342-RL_11_343-s->dpt[3][13])-(OR_10_342*qd[12]-OR_11_343*qd[19])*(RL_10_242-RL_11_243-s->dpt[2][13]
 );
//
  jdqd11 = (OR_12_244-OR_13_245)*(OR_12_244-OR_13_245)+(OR_12_344-OR_13_345)*(OR_12_344-OR_13_345)+(OR_12_244*qd[12]-
 OR_13_245*qd[13])*(RL_12_344-RL_13_345-s->dpt[3][12])-(OR_12_344*qd[12]-OR_13_345*qd[13])*(RL_12_244-RL_13_245-s->dpt[2][12]
 );
