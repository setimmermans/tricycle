...
// Constraints and Constraints Jacobian 
  ...
  RL_3_114 = S11*(s->dpt[2][17]*S13+s->dpt[3][17]*C13);
  RL_3_214 = s->dpt[2][17]*C13-s->dpt[3][17]*S13;
  RL_3_314 = C11*(s->dpt[2][17]*S13+s->dpt[3][17]*C13);
  ...
  JT_3_235_13 = -(RL_3_135*S11+RL_3_335*C11+s->dpt[2][17]*S13+s->dpt[3][17]*C13);
...
// Constraints and Constraints Jacobian 
  ...
  JT_1_220_19 = -(s->dpt[2][24]*S19+s->dpt[3][24]*C19);
...
//
  ...
  Jac_8_13 = Plp22*(RL_7_139*S11+RL_7_339*C11+s->dpt[2][17]*S13+s->dpt[3][17]*C13)-(RL_7_214+RL_7_239)*(Plp12*S11+Plp32*
 C11);
