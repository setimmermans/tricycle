...
// Constraints and Constraints Jacobian 
  ...
  RL_3_112 = s->dpt[3][10]*S10;
  RL_3_312 = s->dpt[3][10]*C10;
  RL_3_113 = s->dpt[2][15]*S10*S12;
  RL_3_213 = s->dpt[2][15]*C12;
  RL_3_313 = s->dpt[2][15]*C10*S12;
  RL_3_134 = RO_3_714*s->dpt[3][17];
  RL_3_234 = RO_3_814*s->dpt[3][17];
  RL_3_334 = RO_3_914*s->dpt[3][17];
  JT_3_134_10 = RL_3_312+RL_3_313+RL_3_334;
  JT_3_334_10 = -(RL_3_112+RL_3_113+RL_3_134);
  JT_3_134_12 = S10*(RL_3_213+RL_3_234);
  JT_3_234_12 = -(RL_3_134*S10+RL_3_334*C10+s->dpt[2][15]*S12);
...
//
  ...
  RL_7_112 = s->dpt[3][10]*S10;
  RL_7_312 = s->dpt[3][10]*C10;
  RL_7_113 = s->dpt[2][15]*S10*S12;
  RL_7_213 = s->dpt[2][15]*C12;
  RL_7_313 = s->dpt[2][15]*C10*S12;
  RL_7_138 = RO_7_714*s->dpt[3][19]+s->dpt[1][19]*(RO_7_114*C15+RO_7_413*S15)-s->dpt[2][19]*(RO_7_114*S15-RO_7_413*C15);
  RL_7_238 = RO_7_814*s->dpt[3][19]+s->dpt[1][19]*(RO_7_214*C15+C12p13*S15)-s->dpt[2][19]*(RO_7_214*S15-C12p13*C15);
  RL_7_338 = RO_7_914*s->dpt[3][19]+s->dpt[1][19]*(RO_7_314*C15+RO_7_613*S15)-s->dpt[2][19]*(RO_7_314*S15-RO_7_613*C15);
...
// Constraints and Constraints Jacobian 
  ...
  RL_1_118 = s->dpt[3][11]*S10;
  RL_1_318 = s->dpt[3][11]*C10;
  RL_1_119 = s->dpt[2][21]*S10*S18;
  RL_1_219 = s->dpt[2][21]*C18;
  RL_1_319 = s->dpt[2][21]*C10*S18;
  PO_1_119 = RL_1_118+RL_1_119+s->dpt[1][4];
  PO_1_219 = RL_1_219+s->dpt[2][11];
  PO_1_319 = RL_1_318+RL_1_319+s->dpt[3][4];
  JT_1_119_10 = RL_1_318+RL_1_319;
  JT_1_319_10 = -(RL_1_118+RL_1_119);
  JT_1_119_18 = RL_1_219*S10;
  JT_1_219_18 = -s->dpt[2][21]*S18;
  JT_1_319_18 = RL_1_219*C10;
  RL_1_132 = RO_1_720*s->dpt[3][23];
  RL_1_232 = RO_1_820*s->dpt[3][23];
  RL_1_332 = RO_1_920*s->dpt[3][23];
...
//
  RL_4_135 = RO_1_720*s->dpt[3][25]+s->dpt[1][25]*(RO_1_120*C21+RO_1_419*S21)-s->dpt[2][25]*(RO_1_120*S21-RO_1_419*C21);
  RL_4_235 = RO_1_820*s->dpt[3][25]+s->dpt[1][25]*(RO_1_220*C21+C18p19*S21)-s->dpt[2][25]*(RO_1_220*S21-C18p19*C21);
  RL_4_335 = RO_1_920*s->dpt[3][25]+s->dpt[1][25]*(RO_1_320*C21+RO_1_619*S21)-s->dpt[2][25]*(RO_1_320*S21-RO_1_619*C21);
...
//
  ...
  RO_5_425 = -C24*S25;
  RO_5_625 = S24*S25;
  RL_5_136 = RO_5_125*s->dpt[1][28]+RO_5_425*s->dpt[2][28];
  RL_5_236 = s->dpt[1][28]*S25+s->dpt[2][28]*C25;
  RL_5_336 = RO_5_325*s->dpt[1][28]+RO_5_625*s->dpt[2][28];
//
  RL_6_137 = RO_5_125*s->dpt[1][27]+RO_5_425*s->dpt[2][27];
  RL_6_237 = s->dpt[1][27]*S25+s->dpt[2][27]*C25;
  RL_6_337 = RO_5_325*s->dpt[1][27]+RO_5_625*s->dpt[2][27];
...
//
  RO_2_127 = C26*C27;
  RO_2_327 = -S26*C27;
  RL_2_133 = -s->dpt[2][31]*(C26*S27*C28-S26*S28);
  RL_2_233 = s->dpt[2][31]*C27*C28;
  RL_2_333 = s->dpt[2][31]*(C26*S28+S26*S27*C28);
...
//
  RO_0_129 = C26*C29;
  RO_0_329 = -S26*C29;
  RL_0_131 = -s->dpt[2][32]*(C26*S29*C30-S26*S30);
  RL_0_231 = s->dpt[2][32]*C29*C30;
  RL_0_331 = s->dpt[2][32]*(C26*S30+S26*S29*C30);
...
//
  h_1 = RL_0_131+s->dpt[1][6]-(PO_1_119+RL_1_132);
  h_2 = -(PO_1_219-RL_0_231+RL_1_232);
  h_3 = RL_0_331+s->dpt[3][6]-(PO_1_319+RL_1_332);
//
  h_4 = RL_2_133-RL_3_112-RL_3_113-RL_3_134-s->dpt[1][4]+s->dpt[1][6];
  h_5 = RL_2_233-RL_3_213-RL_3_234-s->dpt[2][10];
  h_6 = RL_2_333-RL_3_312-RL_3_313-RL_3_334-s->dpt[3][4]+s->dpt[3][6];
//
  Plp11 = PO_1_119+RL_4_135-RL_5_136-s->dpt[1][5];
  Plp21 = PO_1_219+RL_4_235-RL_5_236;
  Plp31 = PO_1_319+RL_4_335-RL_5_336-s->dpt[3][5];
 ...
 *C10);
 ...
 RO_1_820-RL_4_235*RO_1_720));
  ...
  Jacu_7_25 = -(Plp21*(s->dpt[1][28]*C25-s->dpt[2][28]*S25)-RL_5_236*(Plp11*C24-Plp31*S24));
//
  Plp12 = RL_6_137-RL_7_112-RL_7_113-RL_7_138-s->dpt[1][4]+s->dpt[1][5];
  Plp22 = RL_6_237-RL_7_213-RL_7_238-s->dpt[2][10];
  Plp32 = RL_6_337-RL_7_312-RL_7_313-RL_7_338-s->dpt[3][4]+s->dpt[3][5];
...
//
  ...
  Jacu_8_12 = Plp22*(RL_7_138*S10+RL_7_338*C10+s->dpt[2][15]*S12)-(RL_7_213+RL_7_238)*(Plp12*S10+Plp32*C10);
 ...
 RO_7_814-RL_7_238*RO_7_714);
  ...
  Jacu_8_25 = Plp22*(s->dpt[1][27]*C25-s->dpt[2][27]*S25)-RL_6_237*(Plp12*C24-Plp32*S24);
